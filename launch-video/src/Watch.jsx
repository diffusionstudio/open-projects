...
export function Watch(props) {
  ...
  return (
    <rect
      ...
      id="uv25jx"
    >
      <animation type="blur" duration={BLOOM_B / 1000} id="i3negb" />
      <animation type="blur" phase="out" duration={OUT_B / 1000} id="oxye2i" />
      <animation type="fade" phase="out" duration={OUT_O / 1000} id="zzyfjh" />
      <htmlPaint id="rjf2ik">
