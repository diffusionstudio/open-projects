...
export default function Film() {
  ...
  return (
    <stage camera={[0.34, 0, 0, 0.34, 68.85, 105.24]} id="yn90us">
      <scene id="film" name="The Fish Heist" width={W} height={H} fill={paper} active timeline={[20.24, -0.4, 0]} x={41} y={-2} playhead={1.77}>
