...
| Project | What it is |
|---|---|
| [growth-report-custom-controls](growth-report-custom-controls) | An e-commerce growth report and a regional map driven entirely by `@inspect` custom controls: brand, market, language, imagery, layout and timing all switch from the sidebar. |
